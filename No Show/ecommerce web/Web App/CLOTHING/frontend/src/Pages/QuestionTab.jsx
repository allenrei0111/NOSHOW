...
const QuestionsTab = () => {
  ...
  return (
    <div className="questions-tab">
      ...
      <div className="question">
  <h4 onClick={() => toggleAnswer(9)}>Q: Can I change my order after it has been placed?</h4>
  {answersVisible[9] && <p>A: Unfortunately, we cannot guarantee changes to orders once they have been placed. Please contact our support team for assistance.</p>}
</div>
    </div>
  );
};
